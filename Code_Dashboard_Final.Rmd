...
## Hypothesis Test for Median Salary of Students
...
###An Interactive Income to Debt Ratio Density Plot
...
dept_income_plot <- Income_Debt %>%
  ...
  aes(y = median_salary, x = median_debt_monthly_payments*12,
      shape = ownership,color = ownership),alpha = 0.2
  ) +
  geom_point() +
  labs(
...
###An Interactive Scatter Plot of Median Income Versus Yearly Debt Payments
```{r}
ggplotly(dept_income_plot)
```
